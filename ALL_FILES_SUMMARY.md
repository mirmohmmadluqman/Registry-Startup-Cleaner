...
|---|-----------|----------|---------|------|
| 1 | `RegistryStartupCleaner.bat` | Root | Main executable script | ~8 KB |
| 2 | `README.md` | Root | Main documentation | ~5 KB |
...
| # | File Name | Location | Purpose | Size |
|---|-----------|----------|---------|------|
| 5 | `CHANGELOG.md` | Root | Version history | ~2 KB |
| 6 | `CONTRIBUTING.md` | Root | Contribution guidelines | ~3 KB |
| 7 | `SECURITY.md` | Root | Security policy | ~4 KB |
...
| # | File Name | Location | Purpose | Size |
|---|-----------|----------|---------|------|
| 10 | `bug_report.md` | `.github/ISSUE_TEMPLATE/
